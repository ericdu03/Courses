...
If the above paragraph seems a bit complicted, let's try to see it through an example. In fact, let's just take 
...
\end{example}
%fix this, contradiction and contrapositive are basically on the same level here 
