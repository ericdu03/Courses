...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while counter < self.min_range:
            ...
            counter +=1
        while self.min_range <= counter <= self.max_range:
            if index.is_hive:
                return None
            elif len(index.bees) > 0:
                return random_bee(index.bees)
            index = index.entrance
            counter +=1
        return None
        # END Problem 3 and 4
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        # BEGIN Problem 5
        index = self.place
        for i in list(index.bees):
            i.reduce_health(amount)
        if self.health - amount <= 0:
           for j in list(index.bees):
...
class HungryAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        if self.chew_countdown == 0 or self.chew_duration == 0:
            if bee != None:
...
# END Problem 12
    ...
    def action(self, gamestate):
        ...
        while index != None:
            if index.ant != None:
                index.ant.buff()
                if index.ant.is_container and index.ant.ant_contained:
                    index.ant.ant_contained.buff()
            index = index.exit
        # END Problem 12
...
class Bee(Insect):
    ...
    def action(self, gamestate):
        ...
        origin = self.place.entrance
        # Extra credit: Special handling for bee direction

        # if self.slowed == True and self.scared == True:
        #     if self.slowed_duration > 0:
        #         if gamestate.time%2 == 0 and self.scared_duration > 0:
        #             self.move_to(origin)
        #     if self.slowed_duration == 0:
        #         self.slowed == False
        ...
        # elif self.slowed == True:
        #     if gamestate.time%2 == 0 and self.slowed_duration > 0:
        #         self.move_to(destination)
        #     elif gamestate.time %2 == 0 and self.slowed == True:
        #         self.slowed = False
        #         self.move_to(destination)
        #     self.slowed_duration -=1
        ...
        # if self.scared == True and self.slowed == True:
        #     if gamestate.time%2 == 0 and self.slowed_duration > 0 and self.scared_duration > 0:
        #         self.move_to(origin)
        #     elif gamestate.time%2 == 0 and self.slowed_duration == 0 and self.scared_duration > 0 :
        #         self.move_to(origin)
        #     elif gamestate.time%2 == 0 and self.slowed_duration > 0 and self.scared_duration == 0:
        #         self.move_to(destination)
        #     self.scared_duration -=1
        ...
        if self.slowed == True:
            print(f"DEBUG: slowed - {self.slowed_duration}")
            if gamestate.time%2 == 0 and self.slowed_duration > 0:
                if self.scared == False:
                    self.move_to(destination)
            elif self.slowed_duration == 0:
                self.slowed = False
                self.move_to(destination)
            self.slowed_duration -=1
        ...
        if self.scared == True:
            print(f"DEBUG: scared - {self.scared_duration}")
            if self.scared_duration > 0:
                self.move_to(origin)
            elif self.scared_duration == 0:
                self.scared = False
