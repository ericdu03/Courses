...
\begin{document}
	...
	\begin{enumerate}[label=\alph*)]
		...
		\item In \( \mathcal L \), replace the ordinary derivatives \( \psi_{, \mu} = \partial_\mu \psi \) by 
			...
			transformations. 
		\item Derive the Dirac equation from the new Lagrangian \( \mathcal L' \). What is the interpretation of 
			\( A_\mu \)? 
	\end{enumerate}
	\pagebreak
	\section*{Problem 2}
	...
	\( E \), assuming that the other partial amplitudes are negligible. 
	\pagebreak
	\section*{Problem 4}
